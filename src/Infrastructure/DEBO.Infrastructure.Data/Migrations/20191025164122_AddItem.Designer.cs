...
namespace DEBO.Infrastructure.Data.Migrations
{
    ...
    [Migration("20191025164122_AddItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEBO.Core.Entity.Business.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DEBO.Core.Entity.BusinessUser.BusinessUser", b =>
                {
            ...
            modelBuilder.Entity("DEBO.Core.Entity.Item.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DEBO.Core.Entity.BusinessUser.BusinessUser", b =>
                {
                    b.HasOne("DEBO.Core.Entity.Business.Business", "Business")
                        .WithMany("BusinessUsers")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DEBO.Core.Entity.User.User", "User")
                        .WithMany("BusinessUsers")
